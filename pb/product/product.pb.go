...
const file_product_product_proto_rawDesc = "" +
	...
	"\rCreateProduct\x12\x1d.product.CreateProductRequest\x1a\x1e.product.CreateProductResponseB6Z4github.com/fathurzoy/go-grpc-ecommerce-be/pb/productb\x06proto3"
...
var file_product_product_proto_depIdxs = []int32{
	...
	0, // 1: product.ProductSerivice.CreateProduct:input_type -> product.CreateProductRequest
	1, // 2: product.ProductSerivice.CreateProduct:output_type -> product.CreateProductResponse
