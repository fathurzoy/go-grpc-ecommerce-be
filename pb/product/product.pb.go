...
const file_product_product_proto_rawDesc = "" +
	...
	"pagination\x18\x02 \x01(\v2\x1a.common.PaginationResponseR\n" +
	"pagination\x129\n" +
	"\x04data\x18\x03 \x03(\v2%.product.ListProductAdminResponseItemR\x04data2\xee\x03\n" +
	...
	"\x10ListProductAdmin\x12 .product.ListProductAdminRequest\x1a!.product.ListProductAdminResponseB6Z4github.com/fathurzoy/go-grpc-ecommerce-be/pb/productb\x06proto3"
...
var file_product_product_proto_depIdxs = []int32{
	...
	0,  // 12: product.ProductSerivice.CreateProduct:input_type -> product.CreateProductRequest
	2,  // 13: product.ProductSerivice.DetailProduct:input_type -> product.DetailProductRequest
	4,  // 14: product.ProductSerivice.EditProduct:input_type -> product.EditProductRequest
	6,  // 15: product.ProductSerivice.DeleteProduct:input_type -> product.DeleteProductRequest
	8,  // 16: product.ProductSerivice.ListProduct:input_type -> product.ListProductRequest
	11, // 17: product.ProductSerivice.ListProductAdmin:input_type -> product.ListProductAdminRequest
	1,  // 18: product.ProductSerivice.CreateProduct:output_type -> product.CreateProductResponse
	3,  // 19: product.ProductSerivice.DetailProduct:output_type -> product.DetailProductResponse
	5,  // 20: product.ProductSerivice.EditProduct:output_type -> product.EditProductResponse
	7,  // 21: product.ProductSerivice.DeleteProduct:output_type -> product.DeleteProductResponse
	10, // 22: product.ProductSerivice.ListProduct:output_type -> product.ListProductResponse
	13, // 23: product.ProductSerivice.ListProductAdmin:output_type -> product.ListProductAdminResponse
