...
type HighlightProductResponse struct {
	...
	Base          *common.BaseResponse            `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	Pagination    *common.PaginationResponse      `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
	Data          []*HighlightProductResponseItem `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HighlightProductResponse) GetPagination() *common.PaginationResponse {
	if x != nil {
		return x.Pagination
	}
	return nil
...
const file_product_product_proto_rawDesc = "" +
	...
	"pagination\x18\x02 \x01(\v2\x1a.common.PaginationResponseR\n" +
	"pagination\x129\n" +
	"\x04data\x18\x03 \x03(\v2%.product.HighlightProductResponseItemR\x04data2\xc7\x04\n" +
	"\x0fProductSerivice\x12N\n" +
	...
	"\x10ListProductAdmin\x12 .product.ListProductAdminRequest\x1a!.product.ListProductAdminResponse\x12W\n" +
	"\x10HighlightProduct\x12 .product.HighlightProductRequest\x1a!.product.HighlightProductResponseB6Z4github.com/fathurzoy/go-grpc-ecommerce-be/pb/productb\x06proto3"
...
var file_product_product_proto_depIdxs = []int32{
	...
	19, // 13: product.HighlightProductResponse.pagination:type_name -> common.PaginationResponse
	15, // 14: product.HighlightProductResponse.data:type_name -> product.HighlightProductResponseItem
	0,  // 15: product.ProductSerivice.CreateProduct:input_type -> product.CreateProductRequest
	2,  // 16: product.ProductSerivice.DetailProduct:input_type -> product.DetailProductRequest
	4,  // 17: product.ProductSerivice.EditProduct:input_type -> product.EditProductRequest
	6,  // 18: product.ProductSerivice.DeleteProduct:input_type -> product.DeleteProductRequest
	8,  // 19: product.ProductSerivice.ListProduct:input_type -> product.ListProductRequest
	11, // 20: product.ProductSerivice.ListProductAdmin:input_type -> product.ListProductAdminRequest
	14, // 21: product.ProductSerivice.HighlightProduct:input_type -> product.HighlightProductRequest
	1,  // 22: product.ProductSerivice.CreateProduct:output_type -> product.CreateProductResponse
	3,  // 23: product.ProductSerivice.DetailProduct:output_type -> product.DetailProductResponse
	5,  // 24: product.ProductSerivice.EditProduct:output_type -> product.EditProductResponse
	7,  // 25: product.ProductSerivice.DeleteProduct:output_type -> product.DeleteProductResponse
	10, // 26: product.ProductSerivice.ListProduct:output_type -> product.ListProductResponse
	13, // 27: product.ProductSerivice.ListProductAdmin:output_type -> product.ListProductAdminResponse
	16, // 28: product.ProductSerivice.HighlightProduct:output_type -> product.HighlightProductResponse
