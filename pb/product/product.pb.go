...
const file_product_product_proto_rawDesc = "" +
	...
	"\rDetailProduct\x12\x1d.product.DetailProductRequest\x1a\x1e.product.DetailProductResponseB6Z4github.com/fathurzoy/go-grpc-ecommerce-be/pb/productb\x06proto3"
...
var file_product_product_proto_depIdxs = []int32{
	...
	0, // 2: product.ProductSerivice.CreateProduct:input_type -> product.CreateProductRequest
	2, // 3: product.ProductSerivice.DetailProduct:input_type -> product.DetailProductRequest
	1, // 4: product.ProductSerivice.CreateProduct:output_type -> product.CreateProductResponse
	3, // 5: product.ProductSerivice.DetailProduct:output_type -> product.DetailProductResponse
