...
type HelloWorldServiceClient interface {
	HelloWorld(ctx context.Context, in *HelloWolrdRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error)
}
...
func (c *helloWorldServiceClient) HelloWorld(ctx context.Context, in *HelloWolrdRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
...
type HelloWorldServiceServer interface {
	HelloWorld(context.Context, *HelloWolrdRequest) (*HelloWorldResponse, error)
...
func (UnimplementedHelloWorldServiceServer) HelloWorld(context.Context, *HelloWolrdRequest) (*HelloWorldResponse, error) {
...
func _HelloWorldService_HelloWorld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServiceServer).HelloWorld(ctx, req.(*HelloWolrdRequest))
	}
