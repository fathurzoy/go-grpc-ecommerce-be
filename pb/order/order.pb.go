...
type DetailOrderResponseItemProduct struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Name          string                 `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Price         float64                `protobuf:"fixed64,3,opt,name=price,proto3" json:"price,omitempty"`
...
func (x *DetailOrderResponseItemProduct) Reset() {
	*x = DetailOrderResponseItemProduct{}
	mi := &file_order_order_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DetailOrderResponseItemProduct) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DetailOrderResponseItemProduct) ProtoMessage() {}

func (x *DetailOrderResponseItemProduct) ProtoReflect() protoreflect.Message {
	mi := &file_order_order_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DetailOrderResponseItemProduct.ProtoReflect.Descriptor instead.
func (*DetailOrderResponseItemProduct) Descriptor() ([]byte, []int) {
	return file_order_order_proto_rawDescGZIP(), []int{12}
}

func (x *DetailOrderResponseItemProduct) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *DetailOrderResponseItemProduct) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *DetailOrderResponseItemProduct) GetPrice() float64 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *DetailOrderResponseItemProduct) GetQuantity() int64 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
type DetailOrderResponse struct {
	...
	Items            []*DetailOrderResponseItemProduct `protobuf:"bytes,11,rep,name=items,proto3" json:"items,omitempty"`
...
func (x *DetailOrderResponse) GetItems() []*DetailOrderResponseItemProduct {
	if x != nil {
		return x.Items
	}
	return nil
...
const file_order_order_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\x02id\"v\n" +
	"\x1eDetailOrderResponseItemProduct\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05price\x18\x03 \x01(\x01R\x05price\x12\x1a\n" +
	"\bquantity\x18\x04 \x01(\x03R\bquantity\"\x83\x04\n" +
	...
	" \x01(\tR\x10xenditInvoiceUrl\x12;\n" +
	"\x05items\x18\v \x03(\v2%.order.DetailOrderResponseItemProductR\x05items\x12\x14\n" +
	"\x05total\x18\f \x01(\x01R\x05total\x129\n" +
	"\n" +
	"expired_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\texpiredAt\"j\n" +
	"\x18UpdateOrderStatusRequest\x12\x1a\n" +
	"\x02id\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\x02id\x122\n" +
	...
	"\x11UpdateOrderStatus\x12\x1f.order.UpdateOrderStatusRequest\x1a .order.UpdateOrderStatusResponseB4Z2github.com/fathurzoy/go-grpc-ecommerce-be/pb/orderb\x06proto3"
...
var file_order_order_proto_goTypes = []any{
	...
	(*DetailOrderResponseItemProduct)(nil),    // 12: order.DetailOrderResponseItemProduct
...
var file_order_order_proto_depIdxs = []int32{
	...
	12, // 16: order.DetailOrderResponse.items:type_name -> order.DetailOrderResponseItemProduct
